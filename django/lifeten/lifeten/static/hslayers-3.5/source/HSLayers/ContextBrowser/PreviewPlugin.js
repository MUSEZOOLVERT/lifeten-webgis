...
Ext4.define('Ext4.ux.PreviewPlugin', {
    ...
    hideBodyCls: 'x4-grid-row-body-hidden',
        ...
        var bodyField   = this.bodyField,
            ...
            features    = [{
                ...
                getAdditionalData: function(data, idx, record, orig, view) {
                    var getAdditionalData = Ext4.grid.feature.RowBody.prototype.getAdditionalData,
                        additionalData = {
                    ...
                    if (getAdditionalData) {
                        Ext4.apply(additionalData, getAdditionalData.apply(this, arguments));
                    }
