...
Current approach - every layer switcher group has its own OL.filter.
We construct the dropdown lists based on this filter.
Then we update the filter of the group as appropriate.
...
*/
HSLayers.Control.LayerSwitcher.WFSFilterForm = function(config) {
    ...
    HSLayers.Control.LayerSwitcher.WFSFilterForm.superclass.constructor.call(this,config);
};

Ext.extend(HSLayers.Control.LayerSwitcher.WFSFilterForm, Ext.form.FormPanel, { 

    /**
     * Layer group which this filter form belongs to.
     *
     * @name HSLayers.Control.LayerSwitcher.WFSFilterForm.layerGroup
     * @type {HSLayers.Control.LayerSwitcher.LayerGroup}
     */
    layerGroup: null,

    /**
     * Layer to filter.
     * Our layerGroup should have just this one layer.
     * @name HSLayers.Control.LayerSwitcher.WFSFilterForm.layer
     * @type {HSLayers.Layer.WFS}
     */
    layer: null,
     ...
     *
     * @name HSLayers.Control.LayerSwitcher.WFSFilterForm.window
     * @type {Ext.Window}
     */
    window: null,
     ...
     *
     * @name HSLayers.Control.LayerSwitcher.WFSFilterForm.comparisonOperators
     ...
     *
     * @name HSLayers.Control.LayerSwitcher.WFSFilterForm.savedPropertyName
     * @type {String}
     */
     ...
     * and saved in the filter. Default value to start with.
     * 
     * @name HSLayers.Control.LayerSwitcher.WFSFilterForm.savedOperator
     * @type {String}
     */
    savedOperator: null,    
     ...
     * and saved in the filter. Default value to start with.
     * 
     * @name HSLayers.Control.LayerSwitcher.WFSFilterForm.savedValue
     * @type {String}
     */
    savedValue: null,
     ...
     *
     * @name HSLayers.Control.LayerSwitcher.WFSFilterForm.propertyNameCB
     ...
     *
     * @name HSLayers.Control.LayerSwitcher.WFSFilterForm.operatorCB
     * @type {Ext.form.ComboBox}
     */
    operatorCB: null,
     ...
     *
     * @name HSLayers.Control.LayerSwitcher.WFSFilterForm.valueTF
     ...
     *
     * @name HSLayers.Control.LayerSwitcher.WFSFilterForm.comparisonFilterCF
     ...
     * 
     * @name HSLayers.Control.LayerSwitcher.WFSFilterForm.okButton
     * @type Ext.Button 
     */
    okButton: null,
     ...
     * 
     * @name HSLayers.Control.LayerSwitcher.WFSFilterForm.applyButton
     * @type Ext.Button 
     */
    applyButton: null,
     ...
     *
     * @name HSLayers.Control.LayerSwitcher.WFSFilterForm.cancelButton
     * @type Ext.Button
     */
    cancelButton: null,
     ...
     * 
     * @name HSLayers.Control.LayerSwitcher.WFSFilterForm.getComparisonOperators
     * @function
     ...
     *
     * @name HSLayers.Control.LayerSwitcher.WFSFilterForm.onOkButtonClickedSql
     * @function
     */
    onOkButtonClickedSql: function() {
        ...
        // Save the filter
        this.layerGroup.setFilter(filter);
...
console.log(sql);
     ...
     *
     * @name HSLayers.Control.LayerSwitcher.WFSFilterForm.onOkButtonClickedFes
     * @function
     */
     ...
     * and mergeNewParams() into the existing WFS request
     *
     * @name HSLayers.Control.LayerSwitcher.WFSFilterForm.onApplyButtonClickedFes
     * @function
     */
    onApplyButtonClickedFes: function() {
        ...
        // Write filter to FES
        var v110 = new OpenLayers.Format.Filter({version: "1.1.0"});
        var xmlFormat = new OpenLayers.Format.XML();
        var filterElement = v110.write(filter);
...
console.log(fesXml);
     ...
     * Hide the window
     *
     * @name HSLayers.Control.LayerSwitcher.WFSFilterForm.onCancelButtonClicked
     * @function
     */
    ...
    CLASS_NAME: "HSLayers.Control.LayerSwitcher.WFSFilterForm"
});
